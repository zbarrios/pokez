...
public class BattlePokemonModelRowMapper implements RowMapper<BattlePokemonModel> {
  @Override
  public BattlePokemonModel mapRow(ResultSet bp, int rowNum) throws SQLException {
    BattlePokemonModel battlePokemon = new BattlePokemonModel(
